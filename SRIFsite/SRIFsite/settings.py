...
ADMINS = (
     ...
     ('gabriel', 'gabriel_barth-maron@alumni.brown.edu')
)
...
SECRET_KEY = 'y4p70c)pu933kn%9)q+^al6ea4leeoxufqwgqemdb!uef7_y^9'
...
ROOT_URLCONF = 'SRIFsite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'SRIFsite.wsgi.application'
